...
class WorkSchedule(Base):
    """Versionierter Wochenarbeitsplan einer Person (ab 0.20.5)."""
...
class VacationEntitlementEntry(Base):
    ...
    # Fachliche Idempotenz, z. B. ``AUTO_CARRYOVER:42:2026:2027``.
    source_key = Column(String(191), nullable=True, unique=True, index=True)
